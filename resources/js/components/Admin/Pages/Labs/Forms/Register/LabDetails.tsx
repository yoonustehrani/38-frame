...
const LabDetails: FC<LabDetailsProps> = () => {
    ...
    return (
        <>
            ...
            <Input required type="text" maxLength={10} name="owner_national_id" id="owner_national_id" label="کد ملی مدیریت لابراتوار" className="ltr py-2 px-3 h-full"/>
            <Input type="text" maxLength={10} name="website" id="website" label="وب سایت لابراتوار" className="ltr py-2 px-3 h-full" placeholder="اگر وب سایت دارید اینجا وارد کنید"/>
            <div>
                ...
                {bank?.name && (
                    <div className="text-gray-700 w-full flex items-end gap-3 pt-3 px-2 fadeIn">
            ...
            <div className="col-span-full">
                <hr className="mb-6" />
                <h3 className="font-bold text-gray-800 text-lg">روزهای کاری مجموعه شما</h3>
                <WorkingDays />
            </div>
        </>
    );
