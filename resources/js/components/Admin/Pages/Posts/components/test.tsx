...
import { toPersianDateTime } from "./DataTable/utils";
import TableRecord from "./DataTable/TableRecord";
import { useGroupActionList } from "../../../../../hooks/tableHooks";
// import TableRecord from "./TableRecord";


type DBRecordObject = {id: number, [key:string]: string | number | boolean | null}
...
const DataTable: FC<DataTableProps> = ({loading, items}) => {

    const groupedList = useGroupActionList([] as typeof items)
...
//             </TableRecord>
//             <TableRecord>
//                 <p className="text-sm leading-none text-gray-600">{toPersianDateTime(item.created_at)}</p>
//             </TableRecord>
//             <TableRecord>
//                 <p className="text-sm leading-none text-gray-600">{toPersianDateTime(item.updated_at)}</p>
//             </TableRecord>
//             <TableRecord>
