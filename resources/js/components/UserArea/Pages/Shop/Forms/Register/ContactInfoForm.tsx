...
const ContactInfoForm: FC<ContactInfoFormProps> = () => {
    return (
        <>
            ...
            <Input type="text" name="meta[social][instagram]" id="instagram" label="صفحه اینستاگرامی فروشگاه" className="p-3 pl-12 ltr">
            ...
            <Input type="text" name="meta[social][telegram_channel]" id="telegram_channel" label="کانال تلگرامی فروشگاه" className="p-3 pl-12 ltr">
                <div className="h-12 w-10 absolute left-0 top-0 flex justify-center items-center pl-2">
