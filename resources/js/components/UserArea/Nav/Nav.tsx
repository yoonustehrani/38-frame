...
const Nav: FC<NavProps> = () => {
    return (
        <nav className="font-iran-sans mt-5 userarea-menu">
            <ul className="flex flex-col gap-4 a-full">
                <NavItem uri="#1" title="داشبورد" active={true}>
                ...
                <NavItem uri="#4" title="درخواست های خدمات">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
                ...
                <NavItem uri="#5" title="مدیریت آگهی ها">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="20" height="20">
