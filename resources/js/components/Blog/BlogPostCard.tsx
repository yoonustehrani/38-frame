        ...
        <div 
            ...
            >
                ...
                <div className="mt-4 relative grow flex flex-col justify-between">
                    ...
                    <p className="text-sm text-gray-700 text-justify px-1">{description}</p>
                    ...
                    <div className="flex flex-row-reverse items-center justify-between px-2 text-xs">
                        <div 
                        className="flex flex-row-reverse gap-2 items-center text-gray-600"
                        onClick={(e) => {
                            e.preventDefault()
                            window.location.href = author.url
                        }}>
                            <span className="rounded-full overflow-hidden">
                                <img className="h-8 w-8" src={author.avatar} alt={author.name} />
                            </span>
                            <span>{author.name}</span>
                        </div>
                        <div className="flex flex-row-reverse items-center gap-1">
                            <img className="h-5 w-5" src="/icons/eye.svg" alt="" />
